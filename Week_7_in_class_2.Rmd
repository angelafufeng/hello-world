...
Loops are slow because it needs to go through the entire loop with every number (recursive), whereas the vector just goes through each number once. R is vectorized
